...
- `ECMAScript/test262-main/test/built-ins/Array/S15.4.3_A1.1_T2.js`: `TypeError: assert.sameValue failed`
...
- `ECMAScript/test262-main/test/built-ins/Array/from/iter-cstm-ctor.js`: `SyntaxError: unexpected token in expression: Punct('=')`
- `ECMAScript/test262-main/test/built-ins/Array/from/iter-map-fn-err.js`: `SyntaxError: unexpected token in expression: Punct('=')`
...
- `ECMAScript/test262-main/test/built-ins/Array/from/iter-set-elem-prop-err.js`: `SyntaxError: unexpected token in expression: Punct('=')`
...
- `ECMAScript/test262-main/test/built-ins/Array/from/source-object-iterator-1.js`: `SyntaxError: expected ','`
...
- `ECMAScript/test262-main/test/built-ins/Array/length/define-own-prop-length-coercion-order.js`: `SyntaxError: unexpected token in expression: Punct('=')`
